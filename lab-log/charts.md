...
数据：[`metrics.json`](metrics.json)（2026-09-13 03:22）。规范：Skill 内 `charts-spec.md`。
...
xychart-beta
    ...
    y-axis "完成度 %" 0 --> 100
    bar [100, 100, 100, 100, 100, 100, 65, 0, 0, 0, 25]
```
...
02:32 开训。早期 200–800：6.967→2.413。**20K ckpt 已落**（03:03），20K loss 被进度条覆盖，不画虚点。
